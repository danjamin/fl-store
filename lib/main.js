...
export var Store = {
   ...
   * @return mixed Most likely JSON string for ease of use
   */
  serialize: function () {
  ...
  /**
   * How do we deserialize this store's serialized data?
   * Also -- be sure to apply this data to the store ... (import it)
   *
   * @param mixed serializedData The serialized data from the serialize() function
   */
  deserialize: function (serializedData) {
    throw 'Store.deserialize not implemented';
  }
};
